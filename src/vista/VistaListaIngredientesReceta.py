...
class VistaListaIngredientesReceta(QWidget):
    ...
    def __init__(self, interfaz, receta, ingredientes, ingredientesReceta):
        """
    ...
    def mostrar_dialogo_agregar_ingredienteReceta(self):
        ...
        """
        dialogo=VistaCrearIngReceta(None, self.interfaz, self.ingredientes, self.ingredientesReceta)
        dialogo.exec_()
    ...
    def mostrar_dialogo_editar_ingrediente_receta(self, id_ingrediente_receta):
        ...
        """    
        dialogo=VistaCrearIngReceta(self.lista_ings_receta[id_ingrediente_receta], self.interfaz, self.ingredientes,self.ingredientesReceta)
        dialogo.exec_()
        if dialogo.resultado==1:            
