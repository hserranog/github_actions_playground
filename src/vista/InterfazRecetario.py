...
class App_Recetario(QApplication):
    ...
    def eliminar_ingrediente(self, indice):
        ...
        """
        validacion = self.logica.validar_eliminar_ingrediente(indice)
        if validacion == "":
    ...
    def mostrar_ingredientes_receta(self, receta):
        ...
        ingredientesReceta = self.logica.dar_ingredientes_receta(self.receta_actual)
        self.vista_lista_ingReceta = VistaListaIngredientesReceta(self, receta, ingredientes, ingredientesReceta)
