...
class FachadaRecetario:
    ...
    def crear_ingrediente(self, nombre, unidad, valor, sitioCompra):
        ...
        Parámetros:
            nombre (string): El nombre del Ingrediente
            unidad (string): La unidad del Ingrediente
            valor (Integer): El valor del Ingrediente
            sitioCompra (string): El Sitio de Compra del Ingrediente
        '''
        raise NotImplementedError("Método no implementado")
    ...
    def validar_eliminar_ingrediente(self, id_ingrediente):
        ''' Valida si un Ingrediente está en un a Receta
        Parámetros:
